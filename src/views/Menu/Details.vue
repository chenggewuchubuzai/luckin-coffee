  ...
  <div class="detailss">
    ...
    <div class="dec">
        ...
        <ul>
            ...
            <li><em>糖度</em><button  :class="[checkColor3===1?'check':'old']" @click='check3(1)'>全糖(推荐)</button><button :class="[checkColor3===2?'check':'old']" @click='check3(2)'>半糖</button></li>
            <li><em>奶</em><button  :class="[checkColor4===1?'check':'old']" @click='check4(1)'>无奶</button><button :class="[checkColor4===2?'check':'old']" @click='check4(2)'>单份奶</button><button :class="[checkColor4===3?'check':'old']" @click='check4(3)'>双份奶</button></li>
        </ul>
    </div>
    <div class="dks">
    ...
    <div class="pri">
        ...
        <p>{无糖}  + {无奶}</p>
        <van-stepper v-model="value" style="float: right;margin-top:-0.3rem ;" />
